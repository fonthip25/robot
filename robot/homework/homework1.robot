...
Variables   C:\\robot\\homework\\data.yaml
Variables   C:\\robot\\homework\\productData.yaml

Test Template    test case

*** Test Cases ***
Test                  C:\\robot\\homework\\userData.CSV
...
Test case
    ...
    Add to cart    ${product.p1}
    Add to cart    ${product.p3}
    Add to cart    ${product.p6}
...
# ${USER_CSV}    C:\\robot\\homework\\userData.CSV
${browser}     chrome  # ระบุ browser ที่ต้องการใช้ เช่น chrome หรือ firefox
